...
<div class="row">
		...
		<multi-checkout:checkoutSteps checkoutSteps="${checkoutSteps}" progressBarId="${progressBarId}">
            ...
            <div class="place-order-form hidden-xs">
                <form:form action="${placeOrderUrl}" id="placeOrderForm1" modelAttribute="placeOrderForm">
                    ...
                    <button type="button" class="btn btn-block btn-primary btn-place-order" id="placeOrder" title="${placeOrderText}">${placeOrderText}</button>
                </form:form>
            </div>
    ...
    <div class="col-sm-12 col-lg-12">
     <div class="place-order-form visible-xs">
                    <form:form action="${placeOrderUrl}" id="placeOrderForm1" modelAttribute="placeOrderForm">
                        ...
                        <button type="button" class="btn btn-block btn-primary btn-place-order" id="placeOrder" title="${placeOrderText}">
						   ${placeOrderText}
						</button>
                    </form:form>
     </div>
    ...
    <div style="display: none" id="creditscorecheck">
    <p> Checking creditScore.<br> Please wait...
    <img src="/dcxtelcostorefront/_ui/responsive/common/images/spinner.gif">
    </p>
    </div>
</div>
