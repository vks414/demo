 ...
 */
package com.dcx.demo.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(DcxdemoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(DcxdemoFulfilmentProcessConstants.PARENT_PROCESS);
