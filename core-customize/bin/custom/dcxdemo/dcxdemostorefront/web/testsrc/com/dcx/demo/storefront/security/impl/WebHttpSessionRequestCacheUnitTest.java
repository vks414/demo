...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/dcxdemostorefront/electronics/en",
						"https://electronics.local:9002/dcxdemostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/dcxdemostorefront/electronics/en",
						"https://electronics.local:9002/dcxdemostorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/dcxdemostorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/dcxdemostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/dcxdemostorefront/electronics/en",
						"https://electronics.local:9002/dcxdemostorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/dcxdemostorefront",
						"https://electronics.local:9002/dcxdemostorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/dcxdemostorefront",
						"https://electronics.local:9002/dcxdemostorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/dcxdemostorefront/electronics/en",
						"https://electronics.local:9002/dcxdemostorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
