 ...
 */
package com.dcx.demo.test.setup;
...
import com.dcx.demo.test.constants.DcxdemoTestConstants;
import com.dcx.demo.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = DcxdemoTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/dcxdemotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/dcxdemotest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/dcxdemotest/import/cstickets.impex");
			...
			importImpexFile(context, "/dcxdemotest/import/csquotes.impex");
		}
	}
}
