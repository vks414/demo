 ...
 */
package com.dcx.telco.test.setup;
...
import com.dcx.telco.test.constants.DcxtelcoTestConstants;
import com.dcx.telco.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = DcxtelcoTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/dcxtelcotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/dcxtelcotest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/dcxtelcotest/import/cstickets.impex");
			...
			importImpexFile(context, "/dcxtelcotest/import/csquotes.impex");
		}
	}
}
