...
public class DeliveryMethodCheckoutStepController extends AbstractCheckoutStepController
{
	...
	public String enterStep(final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		final List<DeliveryModeData> supportedDeliveryMethods = getSupportedDeliveryMethods(cartData);
	 ...
	 */
	protected List<DeliveryModeData> getSupportedDeliveryMethods(final CartData cartData)
	{
