...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/dcxtelcostorefront/electronics/en",
						"https://electronics.local:9002/dcxtelcostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/dcxtelcostorefront/electronics/en",
						"https://electronics.local:9002/dcxtelcostorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/dcxtelcostorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/dcxtelcostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/dcxtelcostorefront/electronics/en",
						"https://electronics.local:9002/dcxtelcostorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/dcxtelcostorefront",
						"https://electronics.local:9002/dcxtelcostorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/dcxtelcostorefront",
						"https://electronics.local:9002/dcxtelcostorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/dcxtelcostorefront/electronics/en",
						"https://electronics.local:9002/dcxtelcostorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
