 ...
 */
package com.dcx.telco.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(DcxtelcoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(DcxtelcoFulfilmentProcessConstants.PARENT_PROCESS);
