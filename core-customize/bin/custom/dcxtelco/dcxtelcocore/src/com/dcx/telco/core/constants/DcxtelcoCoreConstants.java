 ...
 */
package com.dcx.telco.core.constants;

/**
 * Global class for all DcxtelcoCore constants. You can add global constants for your extension into this class.
 */
public final class DcxtelcoCoreConstants extends GeneratedDcxtelcoCoreConstants
{
	public static final String EXTENSIONNAME = "dcxtelcocore";


	private DcxtelcoCoreConstants()
	{
		//empty
	}
