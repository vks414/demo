...
import com.dcx.demo.service.impl.DefaultDcxdeliverypickupslotsolutionService;
 ...
 */
@IntegrationTest
public class DefaultDcxdeliverypickupslotsolutionServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "dcxdeliverypickupslotsolutionPlatformLogo";

		// when
		final String logoUrl = dcxdeliverypickupslotsolutionService.getHybrisLogoUrl(logoCode);
