 ...
 */
package com.dcx.demo.core.constants;

/**
 * Global class for all DcxdemoCore constants. You can add global constants for your extension into this class.
 */
public final class DcxdemoCoreConstants extends GeneratedDcxdemoCoreConstants
{
	public static final String EXTENSIONNAME = "dcxdemocore";


	private DcxdemoCoreConstants()
	{
		//empty
	}
