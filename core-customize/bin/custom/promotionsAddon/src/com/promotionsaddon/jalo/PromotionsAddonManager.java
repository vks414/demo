 ...
 */
package com.promotionsaddon.jalo;
...
import com.promotionsaddon.constants.PromotionsAddonConstants;



/**
 * This is the extension manager of the PromotionsAddon extension.
 */
public class PromotionsAddonManager extends GeneratedPromotionsAddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PromotionsAddonManager.class.getName());
	 ...
	 */
	public static PromotionsAddonManager getInstance()
	{
		return (PromotionsAddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PromotionsAddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PromotionsAddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PromotionsAddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PromotionsAddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PromotionsAddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
