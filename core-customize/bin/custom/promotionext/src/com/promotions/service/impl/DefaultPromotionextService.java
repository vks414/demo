...
public class DefaultPromotionextService implements PromotionextService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultPromotionextService.class);
	...
	{
		return DefaultPromotionextService.class.getResourceAsStream("/promotionext/sap-hybris-platform.png");
	}
