 ...
 */
package com.dcx.b2b.demo.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Dcxb2bdemoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Dcxb2bdemoFulfilmentProcessConstants.PARENT_PROCESS);
