 ...
 */
package com.dcx.b2b.demo.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, Dcxb2bdemoFulfilmentProcessConstants.PARENT_PROCESS);
