 ...
 */
package com.dcx.b2b.demo.test.setup;
...
import com.dcx.b2b.demo.test.constants.Dcxb2bdemoTestConstants;
import com.dcx.b2b.demo.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Dcxb2bdemoTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/dcxb2bdemotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/dcxb2bdemotest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/dcxb2bdemotest/import/cstickets.impex");
			...
			importImpexFile(context, "/dcxb2bdemotest/import/csquotes.impex");
		}
	}
}
