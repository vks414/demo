 ...
 */
package de.hybris.platform.WhitneyWarneStoreData.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.WhitneyWarneStoreData.constants.ElectronicsstoreConstants;
...
/**
 * This is the extension manager of the Electronicsstore extension.
 */
public class ElectronicsstoreManager extends GeneratedElectronicsstoreManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(ElectronicsstoreManager.class.getName());
	 ...
	 */
	public ElectronicsstoreManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ElectronicsstoreManager called.");
		}
	}
	 ...
	 */
	public static ElectronicsstoreManager getInstance()
	{
		return (ElectronicsstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ElectronicsstoreConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ElectronicsstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ElectronicsstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
